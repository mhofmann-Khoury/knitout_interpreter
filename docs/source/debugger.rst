...
.. code-block:: Python
    ...
    debugger.disable_breakpoint(10) # Debugger will pause on line 10 in your knitout file.
...
You can modify the Step and Step-Carriage-Pass flow by applying conditions for pausing that must be meet. A brief library of useful pausing conditions are available in knitout_interpreter.knitout_debugger.common_debugging_conditions module.
